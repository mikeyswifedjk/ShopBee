...
<body>
    ...
    <!-- Header Content -->
    <a href="no-account-landing-page.php">
      ...
      <div>
          <div class="containers-category">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              $categoryLink = "no-account-category-page.php?category=" . urlencode($row['category']);
    ...
    <div class="daily-discover-title">
      ...
      <a href="no-account-category-page.php?category=<?php echo isset($_GET['category']) ? urlencode($_GET['category']) : ''; ?>&filter=all"><button name="all">ALL</button></a>
      <a href="no-account-category-page.php?category=<?php echo isset($_GET['category']) ? urlencode($_GET['category']) : ''; ?>&filter=latest"><button name="latest">LATEST</button></a>
      <a href="no-account-category-page.php?category=<?php echo isset($_GET['category']) ? urlencode($_GET['category']) : ''; ?>&filter=topsale"><button name="topsale">TOP SALES</button></a>
    </div>
